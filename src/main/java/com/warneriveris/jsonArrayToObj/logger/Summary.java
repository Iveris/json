...
public class Summary {
	...
	// variable holding the number of JSON objects that could not be read or validated
	...
	/**
	 * Returns an integer representing the number of JSON objects successfully read
	 * and parsed by the read service classes.
	 * 
	...
	/**
	 * Increments the skipped variable by one. Method is synchronized to ensure data
	 * integrity across multiple threads
	 */
	...
	/**
	 * String method that records the values of the two class variables and provides
	...
	/**
	 * Prints a summary of how many JSON objects were read or skipped to the user at
